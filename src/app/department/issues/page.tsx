...
import IssueStatusUpdater from './client';

export default async function DepartmentIssuesPage() {
        ...
        <div className="grid-dashboard">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', overflow: 'hidden' }}>
                ...
                <main className="main-content">
                    <h1 style={{ fontSize: '28px', marginBottom: '32px' }}>Issue Tracking</h1>
                                    ...
                                    {issues.rows.length === 0 ? (
                                        ...
                                        issues.rows.map((issue: any) => (
                                            <tr key={issue.issue_id}>
                                                ...
                                                <td>
                                                    <IssueStatusUpdater issueId={issue.issue_id} currentStatus={issue.status} />
                                                </td>
                                            </tr>
                                        ))
                                    )}
